...
use App\Exports\Level1Export;
use App\Imports\Level1Import;
...
class Level1Controller extends Controller
{
    public function index()
    {
        $data = [
            'title' => 'Data Level 1',
            'btn_add' => 'Tambah Level 1'
        ];
        $data['leve1'] = Level1::where('f_account_id', Auth::user()->f_account_id)->get();
        return view('master_data.level1', $data);
    }
    ...
    {
        $data = Level1::where('f_id', $id)->first();
    ...
    public function update(Request $request)
    {
        ...
        $data = Level1::find($request->input('id_f_position_desc'));
    ...
    public function export(){
        return Excel::download(new Level1Export, 'template_level1.xlsx');
    }
    ...
    public function import(Request $request)
{
    ...
    Excel::import(new Level1Import, $request->file('file'));
...
{
    // Ambil semua data
    $data = Level1::where('f_account_id', Auth::user()->f_account_id)->get();
