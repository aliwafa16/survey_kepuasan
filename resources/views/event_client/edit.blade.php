                ...
                <input type="hidden" name="f_event_id" value="{{ $data_account->f_event_id }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="f_corporate_id" name="f_corporate_id"
                            ...
                            @foreach ($akun as $key => $value)
                                <option value="{{ $value->f_account_id }}"
                                    {{ old('f_corporate_id', $data_account->f_corporate_id) == $value->f_account_id ? 'selected' : '' }}>
                                    {{ $value->f_account_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" id="text" aria-describedby="helper-text-explanation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="" name="f_event_name" id="f_event_name"
                            value="{{ old('f_event_name', $data_account->f_event_name) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="date" id="f_event_start" aria-describedby="helper-text-explanation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="" name="f_event_start" id="f_event_start"
                            value="{{ old('f_event_start', Carbon\Carbon::parse($data_account->f_event_start)->format('Y-m-d')) }}">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="f_event_end" aria-describedby="helper-text-explanation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="" name="f_event_end" id="f_event_end"
                            value="{{ old('f_event_end', Carbon\Carbon::parse($data_account->f_event_end)->format('Y-m-d')) }}">
                    </div>
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" id="text" aria-describedby="helper-text-explanation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="" name="f_event_min_respon" id="f_event_min_respon"
                            value="{{ old('f_event_min_respon', $data_account->f_event_min_respon) }}">
                    </div>
                    <div class="mb-3">
